                ...
                <div className="steps">
                    ...
                    <div className="agreement">
                        <div>
                            ...
                            <p>Я принимаю <a href="/Spb-masters.ru_website_privacy_policy.pdf" target="_blank">Политику конфидециальности</a> и <a href="/Spb-masters.ru_User_agreement.pdf" target="_blank">Пользовательское соглашение</a></p>
                        </div>
                    </div>
                    <div className="error-container">
