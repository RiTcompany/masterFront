...
import {SvgComponentProps} from "../interfaces/admin.props.ts";

const SvgComponent: React.FC<SvgComponentProps> = ({num}) =>{
    switch (num){
        case 1:
            return (
        ...
        case 4:
            return (
                <svg fill="#fff" width="20px" height="20px" viewBox="0 -8 72 72" id="Layer_1" data-name="Layer 1"
        ...
        case 5:
            return (
                <svg width="20px" height="20px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#fff">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path fill="var(--ci-primary-color, #fff)"
                              d="M334.627,16H48V496H472V153.373ZM440,166.627V168H320V48h1.373ZM80,464V48H288V200H440V464Z"
                              className="ci-primary"/>
                        <rect width="224" height="32" x="136" y="296" fill="var(--ci-primary-color, #fff)"
                              className="ci-primary"/>
                        <rect width="224" height="32" x="136" y="376" fill="var(--ci-primary-color, #fff)"
                              className="ci-primary"/>
                    </g>
        ...
        case 6:
            return (
                <svg width="20px" height="20px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#ffffff"
                     stroke="#ffffff">
